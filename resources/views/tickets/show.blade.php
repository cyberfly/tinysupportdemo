                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('ticket_description',$ticket->ticket_description,['class'=>'form-control','readonly'=>'readonly']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-push-2">
                                ...
                                <a href="{!! route('tickets.edit',$ticket->id) !!}" class="btn btn-info">Edit Ticket <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                            </div>
